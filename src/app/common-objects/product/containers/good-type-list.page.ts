...
@Component({
  selector: 'app-good-type-list-page',
  template: `
    <nz-collapse>
      <nz-collapse-panel
        nzHeader="Good Type"
...
export class GoodTypeListPage {
  ...
  selectedItems: GoodType[];
  items$: Observable<GoodType[]>;
  destroy$ = new Subject();

...
@Component({
  selector: 'app-service-type-list-page',
  template: `
    <nz-collapse>
      <nz-collapse-panel
        nzHeader="Service Type"
        [nzActive]="true"
        [nzShowArrow]="false"
        [nzDisabled]="true"
      >
...
export class ServiceTypeListPage {
  columnDefs: ColDef[] = [
    { headerName: 'Code', field: 'categoryType.categoryType.code' },
    { headerName: 'Name', field: 'categoryType.categoryType.name' },
    {
      headerName: 'Description',
      field: 'categoryType.categoryType.description',
    },
    {
      headerName: 'Status',
      valueGetter: params => {
        const { data } = params;
        return data.categoryType.statuses[0].statusType.name;
      },
    },
  ];
  ...
  onDoubleClick(item: ServiceType) {
